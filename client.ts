...
client.connect(SERVER_PORT, SERVER_HOST, async () => {
    ...
    const trans = {"object":{"inputs":[{"outpoint":{"index":0,"txid":"740bcfb434c89abe57bb2bc80290cd5495e87ebf8cd0dadb076bc50453590104"}, // MODIFIED
    ...
    "outputs":[{"pubkey":"958f8add086cc348e229a3b6590c71b7d7754e42134a127a50648bf07969d9a0","value":10}],"type":"transaction"},"type":"object"}
